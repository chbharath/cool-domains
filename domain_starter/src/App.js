...
const tld = '.ninja';
const CONTRACT_ADDRESS = '0x2Ba0ea9f0deF51BbCED7d2dCe3940C2Ae3504E61';
...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
	...
	console.log('Connected to ' + networks[chainId]);
};
		...
		<div className="App">
			...
			<div className="header-container">
				<header>
					...
					<div className="right cta-button service-button">
